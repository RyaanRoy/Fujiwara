...
module.exports.run = async (client, message, args) => {
	...
	if (!helpArgs[0]) {
		...
		.addField(`> <a:dev:817788400471638016> Utility`, `enlarge, reminder, wikipedia, urban, roblox, serverinfo, serverav, avatar, whois, roleinfo, channel, embed(use ;), imageembed, reverse, setafk, snipe, stats, timer, translate, weather, youtubesearch`, false)

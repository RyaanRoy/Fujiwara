...
module.exports.run = async (client, message, args) => {
	...
	if (!helpArgs[0]) {
		const embed = new Discord.MessageEmbed()
			...
			.addField(
				"**🎃Fun**",
				"`8ball`, `akinator(do not reply to the embed as it will trigger chatbot)`, `ship`, `animesearch`, `deaes256`, `kiss`, `meme`, `ngif`, `hug`, `pat`, `poke`, `smug`, `tickle`, `youtubetogether (ytt)`, `betrayal(btt)`"
			)
			.addField(
				"**:tada:Giveaways**",

...
module.exports.run = async (client, message, args) => {
	...
	if (!helpArgs[0]) {
		const embed = new Discord.MessageEmbed()
			...
			.addField(
				"**⚙utility**",
				"`aes256`, `reminder`, `wikipedia`, `urban`, `roblox`,`serverinfo`, `serverav`, `avatar`, `channel`, `embed`, `imageembed`, `roleinfo`, `reverse`, `setafk`, `snipe`, `stats`, `timer`, `translate`, `whois`, `weather`"
			)
			.addField(
				"**🎃Fun**",
